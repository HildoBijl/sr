	...
	render() {
		return (
			<div className="home">
				...
				<p className="intro">Via deze website delen wij onze <Link to={{ type: 'EXPERIENCES' }}>ervaringen</Link> met elkaar en met de buitenwereld. Dankzij de <Link to={{ type: 'MAP' }}>interactieve kaart</Link> weten we elkaar te vinden.</p>
